...
public class Application {
	...
	public static void main(String[] args) {
		...
		int age = 20;
		char gender = '남';
		String[] hobby = new String[] {"축구", "볼링", "테니스"}; // 정보입력 시 하나하나 입력하는 방식
		...
		System.out.println(); // 회원정보를 담을 수 있는 클래스를 따로 만들면 효율적일 것이다
