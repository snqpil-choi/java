...
public class Application {
	...
	public static void main(String[] args) {
		...
		statickeyword sta = new statickeyword();
	
		System.out.println("non sta: " + sta.getNonStaticCount());
		System.out.println("sta : " + sta.getStaticCount());
		...
		statickeyword sta2 = new statickeyword();
		
		System.out.println("non sta: " + sta2.getNonStaticCount());
		System.out.println("sta : " + sta2.getStaticCount());
	
		staticMethodTest sta_m = new staticMethodTest();
		
		sta_m.staticMethod();// 권장 하지 않음.
