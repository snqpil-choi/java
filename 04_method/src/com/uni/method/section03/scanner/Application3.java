...
public class Application3 {
	...
	public static void main(String[] args) {
	    ...
	    */
		...
		/* 스캐너 주의 사항 */
		/*
		 * 스캐너의 next 메소드들은 입력한 내용을 버퍼로부터 토큰단위로 분리해서 읽어온다. 그래서 크게 두 가지 사항을 주의해야 한다. 1.
		 * next()로 문자열 입력 받은 후 정수, 실수, 논리값 입력 받을 때 2. 정수, 실수, 논리값 입력 후 next()로 문자열 입력받을
		 * 때
		 */
		...
		System.out.print("공백이 있는 문자열을 하나 입력해주세요 : "); // 엔터가 버퍼에 남아있어서 바로 출력됨
