...
public class Application3 {
	...
	public static void main(String[] args) {
	       ...
	       * 4. 클래스(static)변수
	       * 
	       * 지역변수는 선언한 메소드 블럭 내부에서만 사용이 가능하다. 이것을 지역변수의 스코프(영역)라고 한다.
		...
		app3.testMethod(40);
		//app3.testMethod("40");
		app3.testMethod1(40, 20, 30); // 매개변수 개수가 1개이기 때문에 불가능하다
		//app3..testMethod(); // 인자값이 없어 오류 발생
	...
	public void testMethod1(int age, int b, int c) {
		System.out.println("당신의 나이는 " + age + "세 입니다.");
	}
}
