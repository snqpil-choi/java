...
public class Application {
	...
	public static void main(String[] args) {
	     ...
	     * 클래스나 메소드 내부에서 사용되는 객체의 타입 안정성을 높일 수 있으며,
	     ...
	     * 
	     * 제네릭 프로그래밍
	     * 데이터의 형식에 의존하지 않고 하나의 값이 여러 다른 데이터 타입들을
	     *  가질 수 있는 기술에 중점을 두어 재사용성을 높일 수 있는 프로그래밍 방식이다.
	     * */
		...
		//gt2.setValue(new Integer(10)); // 타입 제한
		gt2.setValue("남주혁");
