...
public class Application3 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 기본적으로 배열을 선언하고 할당하게 되면 배열의 각 인덱스에는 자바에서 지정한 기본값으로 초기화가 된 상태가 된다. heap영역은 값이
		 * 없는 빈 공간이 존재할 수 없다.
		 */

		/*
		 * 값의 형태 별 기본값 정수 : 0 실수 : 0.0 논리 : false 문자 : \u0000 참조 : null
		 */
		...
		/*
		 * 자바에서 지정한 기본값 외의 값으로 초기화를 하고싶은 경우 블럭을 이용한다. 블럭을 사용하는 경우에는 new를 사용하지 않아도 되며, 값의
		 * 갯수만큼 자동으로 크기가 설정된다.
		 */
