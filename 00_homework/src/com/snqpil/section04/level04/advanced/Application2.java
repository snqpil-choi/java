package com.snqpil.section04.level04.advanced;
...
public class Application2 {
	...
	public static void main(String[] args) {
		...
		if (mon >= 50000000) {
			bon = 0.05;
		} else if (mon >= 30000000) {
			bon = 0.03;
		} else if (mon >= 10000000) {
			bon = 0.01;
		} else {
			bon = 0;
		}
		...
		System.out.println("======================");
		System.out.println("매출액 : " + mon);
		System.out.println("보너스율 : " + (int) (bon * 100) + "%");
		System.out.println("월 급여 : " + sal);
		System.out.println("보너스 금액 : " + (int) (mon * bon));
		System.out.println("======================");
		System.out.println("총 급여 : " + (int) (sal + (mon * bon)));
