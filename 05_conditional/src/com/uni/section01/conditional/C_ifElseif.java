...
//	    
//	    if (answer == 1) {
//	    	System.out.print("금도끼는 당신의 것이 아닙니다. 산신령이 사라졌습니다.");
//	    } else if (answer == 2) {
//	    	System.out.print("은도끼는 당신의 것이 아닙니다. 산신령이 사라졌습니다.");
//	    } else {
//	    	System.out.print("산신령이 칭찬하며 모든 도끼를 주었습니다.");
//	    }
	    
	    String answer2 = sc.nextLine();
	    if (answer2.equals("금도끼")) {
	    	System.out.print("금도끼는 당신의 것이 아닙니다.");
	    } else if (answer2.equals("은도끼")) {
	    	System.out.print("은도끼는 당신의 것이 아닙니다.");
	    } else {
	    	System.out.print("산신령이 칭찬하며 모든 도끼를 주었습니다.");
	    }
	    
	    /* 대답 여부와 상관없이 마지막에 실행하는 내용 */
	    System.out.println("산신령이 사라졌습니다.");
