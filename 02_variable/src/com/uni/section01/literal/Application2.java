...
public class Application2 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
	      ...
	      System.out.println(123 / 10); // 정수끼리의 연산이기 때문에 정수로 나옴 (같은 타입끼리만 연산이 가능하다)
	      System.out.println(123 % 10); // 나머지 구하기(mod도 가능)
	      ...
	      System.out.println(1.23 / 10.0); 
	      System.out.println(1.23 % 1.0);  // 결과 : 0.2299.. 근사치 발생 (소수 연산시)  
	      ...
	      System.out.println('a' + 'b');//195 유니코드와 아스키코드에 대한 이해 필요
